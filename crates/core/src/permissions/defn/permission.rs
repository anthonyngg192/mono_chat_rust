...
pub static ALLOW_IN_TIMEOUT: Lazy<u64> =
    Lazy::new(|| Permission::ViewChannel + Permission::ReadMessageHistory);
...
pub static DEFAULT_PERMISSION_DIRECT_MESSAGE: Lazy<u64> =
    Lazy::new(|| DEFAULT_PERMISSION.add(Permission::ManageChannel + Permission::React));
pub static DEFAULT_PERMISSION_SERVER: Lazy<u64> = Lazy::new(|| {
    DEFAULT_PERMISSION
        .add(Permission::React + Permission::ChangeNickname + Permission::ChangeAvatar)
});
